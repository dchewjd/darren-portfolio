  ...
  return (
    ...
    >
      ...
      <div id="about" className="max-w-2xl py-24 ">
        ...
        <br />
        <p>
          Hello! My name is Darren, and I'm a software engineer with 3+ years of
          experience in creating engaging and dynamic web interfaces. My passion
          is crafting digital experiences that are both beautiful and
          functional, and that have a real impact on people's lives.
        </p>
        <br />
        <p>
          I'm constantly striving to stay up-to-date with the latest trends and
          technologies to deliver cutting-edge solutions that meet the demands
        ...
        <p>
          ...
          technology to drive success and create meaningful solutions that make
          a difference in people's lives. If you're looking for a skilled and
          dedicated software engineer to bring your digital vision to life, I'd
        ...
        >
          ...
          <Tabs.Content value="tab1" className="">
            ...
            <ul className="ml-4 list-disc list-outside marker:text-orange-400 gap-1 space-y-4 ">
              ...
              <li>
                Collaborated with cross-functional agile teams to prioritize and
                scope feature requests, ensuring that the most impactful
          ...
          <Tabs.Content value="tab2" className="">
            ...
            <ul className="ml-4 list-disc list-outside marker:text-orange-400 gap-1 space-y-4 ">
              <li>
                Kickstarted the development of a high-traffic web application as
                part of Immigration & Checkpoints Authority's Digital
                Transformation initiative, delivering a reliable and
                user-friendly platform for millions of users
              </li>
              <li>
                Revamped an outdated web application, improving site performance
                by 20% and enhancing the user experience through responsive
              ...
              <li>
                ...
                specific needs, resulting in increased customer satisfaction and
                retention
              </li>
              <li>
              ...
              <li>
                ...
                multiple platforms, including web and mobile devices, leveraging
                the latest tools and technologies to enhance performance and
                mitigate risks.
              </li>
            </ul>
          </Tabs.Content>
